...
try:
    ...
    cursor.execute("insert into proveedores values('idprov1','Element','562-352-143','Rúa de Alexandre Bóveda','986453328','ElementUrban@gmail.com')")
    cursor.execute("insert into proveedores values('idprov2','Blind','150-488-654','Av. Ricardo Mella Nª87','955125688','Blind@gmail.deu')")
    cursor.execute("insert into proveedores values('idprov3','Powell','563-234-789','Rúa da Coruña Nº76','986097984','Powell@enterprise.com.eng')")

    cursor.execute("insert into productos values('232051760','6es7540-3220-age0','Tablas completas de skate y longboard', 100, 110.00,'idprov1')")
    ...
    cursor.execute("insert into facturasClientes values(1,'Novalbos Wave Company','986208787','Rúa Pintor Laxeiro Nº16','NovalbosWave@gmail.com')")
    cursor.execute("insert into facturasClientes values(1,'Cromoly','986502010','Rúa de Urzaiz Nº61','Cromoly@gmail.es')")
